...
%LD% %LDFLAGS% -o kernel.tmp kernel.o kernel/init.o kernel/cpu.o kernel/interrupts.o kernel/mem.o kernel/screen.o kernel/sched.o kernel/shell.o kernel/keyboard.o kernel/paging.o kernel/exceptions.o kernel/pit.o kernel/syscall.o drivers/ata.o drivers/fs.o
